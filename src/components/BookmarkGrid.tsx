      ...
      <div className="flex flex-col gap-6 mb-8">
        ...
        {hasBookmarks && (
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-end">
            {/* Bulk action buttons - stack vertically on mobile, horizontal on desktop */}
            {isSelectMode && selectedBookmarks.length > 0 && (
              <div className="flex flex-col w-full max-w-xs gap-3 sm:flex-row sm:w-auto sm:max-w-none">
                <Button 
                  variant="outline" 
                  size="sm" 
            ...
            <Button 
              ...
              } ${isSelectMode && selectedBookmarks.length > 0 ? 'w-full max-w-xs sm:w-auto' : ''}`}
            >
              {isSelectMode ? (
                <>
                  <X className="h-4 w-4" />
