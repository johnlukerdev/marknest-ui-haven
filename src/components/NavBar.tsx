...
const NavBar: React.FC<NavBarProps> = ({
  ...
  return <>
      ...
      <>
              {/* Left button */}
              {customBottomBar.leftButton && <Button variant="ghost" className="h-full w-1/3 flex flex-col items-center justify-center rounded-none gap-1 hover:bg-accent hover:text-accent-foreground" onClick={customBottomBar.leftButton.onClick} disabled={customBottomBar.leftButton.disabled}>
              ...
              {/* Center button */}
              {customBottomBar.centerButton && <Button variant="ghost" className="h-full w-1/3 flex flex-col items-center justify-center rounded-none gap-1 hover:bg-accent hover:text-accent-foreground" onClick={customBottomBar.centerButton.onClick} disabled={customBottomBar.centerButton.disabled}>
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                <SheetTrigger asChild>
                  <Button variant="ghost" className="h-full w-1/3 flex items-center justify-center rounded-none hover:bg-accent hover:text-accent-foreground">
      ...
      <>
        ...
        location.pathname !== '/archive' && <Button variant="ghost" className="h-full w-1/3 flex flex-col items-center justify-center rounded-none gap-1 hover:bg-accent hover:text-accent-foreground" onClick={handleBottomBarArchive} disabled={selectedBookmarks.length === 0}>
        ...
        location.pathname !== '/archive' && <Button variant="ghost" className="h-full w-1/3 flex flex-col items-center justify-center rounded-none gap-1 hover:bg-accent hover:text-accent-foreground" onClick={handleBottomBarDelete} disabled={selectedBookmarks.length === 0}>
