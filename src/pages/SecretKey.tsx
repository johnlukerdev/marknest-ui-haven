            ...
            <div className="bg-card border border-border/60 rounded-3xl p-6 sm:p-10 shadow-2xl shadow-black/5">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground text-base sm:text-lg">
                  Enter your code to access the dashboard
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  <Input id="secret-key-input" type="text" placeholder="Enter your secret key…" value={secretKey} onChange={handleInputChange} className="w-full aspect-square min-h-[180px] sm:min-h-[220px] md:min-h-[240px] text-lg sm:text-xl md:text-2xl rounded-3xl border-2 border-border/50 bg-background/80 backdrop-blur-sm focus:border-indigo-500 transition-all duration-300 shadow-lg focus:shadow-xl focus:shadow-indigo-500/10 p-6 sm:p-8 focus:ring-0 focus:ring-offset-0 focus:outline-none font-['Poppins'] font-medium tracking-wide text-left flex items-start justify-start resize-none placeholder:absolute placeholder:top-6 placeholder:left-6 sm:placeholder:top-8 sm:placeholder:left-8 placeholder:text-lg sm:placeholder:text-xl placeholder:font-['Inter'] placeholder:text-muted-foreground/60 placeholder:pointer-events-none\n" />
